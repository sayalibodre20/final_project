...
<table className="table">
  ...
  {/* {AllCustomers.map(customer => (
       ...
       <tr>
      <td scope="col">01</td>
      <td scope="col">Kunal</td>
      <td scope="col">8007234993</td>
      <td scope="col">kunalbhangale09@gmail.com</td>
      <td scope="col">C-13</td>
      <td scope="col">Chinchwad</td>
      <td scope="col">411044</td>
      {/* <td scope="col"></td>
      <td scope="col"></td> */}
    </tr>
    ...
    <tr>
      <td scope="col">02</td>
      <td scope="col">Sayali</td>
      <td scope="col">9518301817</td>
      <td scope="col">bodresayali19@gmail.com</td>
      <td scope="col">Balaji Niwas</td>
      <td scope="col">Katraj</td>
      <td scope="col">411024</td>
      {/* <td scope="col"></td>
      <td scope="col"></td> */}
    </tr>
  </tbody>
