...
<div className="input-group mb-3 mt-3">
  ...
  <input type="text" value={id} className="form-control" placeholder="01" aria-label="Username" aria-describedby="basic-addon1" readOnly/>
</div>
<div className="input-group mb-3">
  <div className="input-group-prepend">
    <span className="input-group-text" id="basic-addon1">name@</span>
  </div>
  <input type="text" value={name} className="form-control" placeholder="Kunal" aria-label="Username" aria-describedby="basic-addon1" readOnly/>
</div>
<div className="input-group mb-3">
  <div className="input-group-prepend">
    <span className="input-group-text" id="basic-addon1">phone@</span>
  </div>
  <input type="text" value={phone} className="form-control" placeholder="8007234993" aria-label="Username" aria-describedby="basic-addon1" readOnly/>
</div>
<div className="input-group mb-3">
  <div className="input-group-prepend">
    <span className="input-group-text" id="basic-addon1">email@</span>
  </div>
  <input type="text" value={email} className="form-control" placeholder="kunalbhangale09@gmail.com" aria-label="Username" aria-describedby="basic-addon1" readOnly/>
</div>
<div className="input-group mb-3">
  <div className="input-group-prepend">
    <span className="input-group-text" id="basic-addon1">house@</span>
  </div>
  <input type="text" value={house_no} className="form-control" placeholder="C-13" aria-label="Username" aria-describedby="basic-addon1" readOnly/>
</div>
<div className="input-group mb-3">
  <div className="input-group-prepend">
    <span className="input-group-text" id="basic-addon1">city@</span>
  </div>
  <input type="text" value={city} className="form-control" placeholder="Chinchwad" aria-label="Username" aria-describedby="basic-addon1" readOnly/>
</div>
<div className="input-group mb-3">
  <div className="input-group-prepend">
    <span className="input-group-text" id="basic-addon1">zipcode@</span>
  </div>
  <input type="text" value={zipcode} className="form-control" placeholder="411044" aria-label="Username" aria-describedby="basic-addon1" readOnly/>
</div>
<hr></hr>
...
<div class="collapse" id="alltransaction">
  ...
  <tbody>
    {/* {Alltransaction.map (t=>(
     ...
     <tr>
      <td scope="col">#</td>
      <td scope="col">11001</td>
      <td scope="col">deposit</td>
      <td scope="col">5000</td>
      <td scope="col">43056</td>
      <td scope="col">2023-08-29</td>
    </tr>
  </tbody>
</table>
  </div>
